...
class Movie():
    ...
    This comment block is printed when we type print(media.Movie.__doc__)
    """
    def __init__(
        self, movie_title,
        movie_storyline,
    ...
    def show_trailer(self):
        """link is stored in instance variable called
        trailer_youtube_url access this variable thru self keyword
        """
