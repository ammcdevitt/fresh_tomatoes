...
forgetting_sarah_marshall = media.Movie(
    ...
    "Peter takes a Hawaiian vacation to get over his recent break-up.",
...
elf = media.Movie(
    "Elf",
    "One of Santa's elves learns he is a human and goes to New York "
    "City to meet his biological father.",
...
no_reservations = media.Movie(
    "No Reservations",
    "The life of a top chef changes when she becomes the guardian "
    "of her young niece.",
...
hot_rod = media.Movie(
    ...
    "of his life - to clear fifteen buses to raise money for his "
    "abusive stepfather Frank's life-saving heart operation.",
...
i_love_you_man = media.Movie(
    "I Love You, Man",
    "Friendless Peter Klaven goes on a series of man-dates to "
    "find a Best Man for his wedding.",
...
"""Function open_movies_page takes in a list, so we
need to create an list"""
movies = [
